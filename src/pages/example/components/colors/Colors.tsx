    ...
    <div>
      <Card title="All Colors">
        <div className="space-y-5">
          <div>
            <div className="col-span-2 mb-6 text-base font-medium text-slate-900 dark:text-slate-300">
              Bases
            </div>
            <div className="flex flex-wrap space-xy-5">
              <div>
                ...
                <div className="flex-1 pt-1 my-1 text-sm dark:text-slate-300">
                  Dark
                </div>
                <div className="text-sm flex-0 dark:text-slate-300">
                  #0F172A
                </div>
              </div>
              <div>
